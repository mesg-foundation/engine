...
func TestStatus(t *testing.T) {
	require.Equal(t, "Created", Status_Created.String())
	require.Equal(t, "InProgress", Status_InProgress.String())
	require.Equal(t, "Completed", Status_Completed.String())
	require.Equal(t, "Failed", Status_Failed.String())
}
