...
// ExecutionRequest represents a request of an execution.
...
// ExecutionResult represents a single result of an execution.
type ExecutionResult struct {
	// Hash is a unique hash to identify this execution's result.
	Hash github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,1,opt,name=hash,proto3,customtype=github.com/mesg-foundation/engine/hash.Hash" json:"hash" hash:"-"`
	// requestHash is hash of the associated request.
...
func (*ExecutionResult_Outputs) isExecutionResult_Result() {}
...
func (m *ExecutionResult) GetOutputs() *types.Struct {
	if x, ok := m.GetResult().(*ExecutionResult_Outputs); ok {
		return x.Outputs
	}
	return nil
}
...
func (m *ExecutionResult) GetError() string {
	if x, ok := m.GetResult().(*ExecutionResult_Error); ok {
		return x.Error
	}
	return ""
}
...
func (*ExecutionResult) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func init() {
	...
	proto.RegisterType((*ExecutionRequest)(nil), "mesg.types.ExecutionRequest")
	proto.RegisterType((*ExecutionResult)(nil), "mesg.types.ExecutionResult")
}
...
var fileDescriptor_776e2c5022e94aef = []byte{
	...
	,
}
...
func (this *ExecutionRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ExecutionRequest)
	if !ok {
		that2, ok := that.(ExecutionRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ExecutionResult_Outputs) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ExecutionResult_Outputs)
	if !ok {
		that2, ok := that.(ExecutionResult_Outputs)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ExecutionResult_Error) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ExecutionResult_Error)
	if !ok {
		that2, ok := that.(ExecutionResult_Error)
		if ok {
			that1 = &that2
		} else {
			return false
