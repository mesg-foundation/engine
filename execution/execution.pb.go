...
const (
	...
	// Passed is an status after voting phase.
	...
	// Voting is an initial status after execution creation.
	Status_Voting Status = 5
)
...
type Execution struct {
	...
	Confs                int64    `protobuf:"varint,16,opt,name=confs,proto3" json:"confs,omitempty" hash:"-"`
	UpdateConfs          int64    `protobuf:"varint,17,opt,name=updateConfs,proto3" json:"updateConfs,omitempty" hash:"-"`
...
var fileDescriptor_776e2c5022e94aef = []byte{
	...
	,
}
...
func (this *Execution) Equal(that interface{}) bool {
	...
	if this.Confs != that1.Confs {
		return false
	}
	if this.UpdateConfs != that1.UpdateConfs {
		return false
	}
