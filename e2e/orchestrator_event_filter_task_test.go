...
func testOrchestratorEventFilterTask(executionStream pb.Execution_StreamClient, resultStream pb.Result_StreamClient, instanceHash hash.Hash) func(t *testing.T) {
	return func(t *testing.T) {
		...
		t.Run("pass filter", func(t *testing.T) {
			...
			t.Run("check completed execution", func(t *testing.T) {
				...
				require.Equal(t, "shouldMatch", res.GetOutputs().Fields["msg"].GetStringValue())
