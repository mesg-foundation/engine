...
import (
	...
	pCore "github.com/mesg-foundation/core/protobuf/core"
...
func (s *Server) register() error {
	...
	pService.RegisterServiceServer(s.instance, serviceServer)
	pCore.RegisterCoreServer(s.instance, coreServer)
