...
func (_m *MockDocker) BuildCachePrune(ctx context.Context) (*types.BuildCachePruneReport, error) {
	ret := _m.Called(ctx)
...
func (_m *MockDocker) BuildCancel(ctx context.Context, id string) error {
...
func (_m *MockDocker) ClientVersion() string {
	ret := _m.Called()
...
func (_m *MockDocker) Close() error {
	ret := _m.Called()
...
func (_m *MockDocker) ConfigCreate(ctx context.Context, config swarm.ConfigSpec) (types.ConfigCreateResponse, error) {
...
func (_m *MockDocker) ConfigInspectWithRaw(ctx context.Context, name string) (swarm.Config, []byte, error) {
...
func (_m *MockDocker) ConfigList(ctx context.Context, options types.ConfigListOptions) ([]swarm.Config, error) {
...
func (_m *MockDocker) ConfigRemove(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *MockDocker) ConfigUpdate(ctx context.Context, id string, version swarm.Version, config swarm.ConfigSpec) error {
...
func (_m *MockDocker) ContainerAttach(ctx context.Context, _a1 string, options types.ContainerAttachOptions) (types.HijackedResponse, error) {
...
func (_m *MockDocker) ContainerCommit(ctx context.Context, _a1 string, options types.ContainerCommitOptions) (types.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) ContainerCreate(ctx context.Context, config *container.Config, hostConfig *container.HostConfig, networkingConfig *network.NetworkingConfig, containerName string) (container.ContainerCreateCreatedBody, error) {
...
func (_m *MockDocker) ContainerDiff(ctx context.Context, _a1 string) ([]container.ContainerChangeResponseItem, error) {
...
func (_m *MockDocker) ContainerExecAttach(ctx context.Context, execID string, config types.ExecStartCheck) (types.HijackedResponse, error) {
...
func (_m *MockDocker) ContainerExecCreate(ctx context.Context, _a1 string, config types.ExecConfig) (types.IDResponse, error) {
...
func (_m *MockDocker) ContainerExecInspect(ctx context.Context, execID string) (types.ContainerExecInspect, error) {
...
func (_m *MockDocker) ContainerExecResize(ctx context.Context, execID string, options types.ResizeOptions) error {
...
func (_m *MockDocker) ContainerExecStart(ctx context.Context, execID string, config types.ExecStartCheck) error {
	ret := _m.Called(ctx, execID, config)
...
func (_m *MockDocker) ContainerExport(ctx context.Context, _a1 string) (io.ReadCloser, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *MockDocker) ContainerInspect(ctx context.Context, _a1 string) (types.ContainerJSON, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *MockDocker) ContainerInspectWithRaw(ctx context.Context, _a1 string, getSize bool) (types.ContainerJSON, []byte, error) {
...
func (_m *MockDocker) ContainerKill(ctx context.Context, _a1 string, signal string) error {
...
func (_m *MockDocker) ContainerList(ctx context.Context, options types.ContainerListOptions) ([]types.Container, error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) ContainerLogs(ctx context.Context, _a1 string, options types.ContainerLogsOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) ContainerPause(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *MockDocker) ContainerRemove(ctx context.Context, _a1 string, options types.ContainerRemoveOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) ContainerRename(ctx context.Context, _a1 string, newContainerName string) error {
...
func (_m *MockDocker) ContainerResize(ctx context.Context, _a1 string, options types.ResizeOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) ContainerRestart(ctx context.Context, _a1 string, timeout *time.Duration) error {
...
func (_m *MockDocker) ContainerStart(ctx context.Context, _a1 string, options types.ContainerStartOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) ContainerStatPath(ctx context.Context, _a1 string, path string) (types.ContainerPathStat, error) {
...
func (_m *MockDocker) ContainerStats(ctx context.Context, _a1 string, stream bool) (types.ContainerStats, error) {
...
func (_m *MockDocker) ContainerStop(ctx context.Context, _a1 string, timeout *time.Duration) error {
	ret := _m.Called(ctx, _a1, timeout)
...
func (_m *MockDocker) ContainerTop(ctx context.Context, _a1 string, arguments []string) (container.ContainerTopOKBody, error) {
...
func (_m *MockDocker) ContainerUnpause(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *MockDocker) ContainerUpdate(ctx context.Context, _a1 string, updateConfig container.UpdateConfig) (container.ContainerUpdateOKBody, error) {
...
func (_m *MockDocker) ContainerWait(ctx context.Context, _a1 string, condition container.WaitCondition) (<-chan container.ContainerWaitOKBody, <-chan error) {
...
func (_m *MockDocker) ContainersPrune(ctx context.Context, pruneFilters filters.Args) (types.ContainersPruneReport, error) {
...
func (_m *MockDocker) CopyFromContainer(ctx context.Context, _a1 string, srcPath string) (io.ReadCloser, types.ContainerPathStat, error) {
...
func (_m *MockDocker) CopyToContainer(ctx context.Context, _a1 string, path string, content io.Reader, options types.CopyToContainerOptions) error {
...
func (_m *MockDocker) DaemonHost() string {
	ret := _m.Called()
...
func (_m *MockDocker) DialSession(ctx context.Context, proto string, meta map[string][]string) (net.Conn, error) {
...
func (_m *MockDocker) Dialer() func(context.Context) (net.Conn, error) {
	ret := _m.Called()
...
func (_m *MockDocker) DiskUsage(ctx context.Context) (types.DiskUsage, error) {
	ret := _m.Called(ctx)
...
func (_m *MockDocker) DistributionInspect(ctx context.Context, _a1 string, encodedRegistryAuth string) (registry.DistributionInspect, error) {
...
func (_m *MockDocker) Events(ctx context.Context, options types.EventsOptions) (<-chan events.Message, <-chan error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) HTTPClient() *http.Client {
	ret := _m.Called()
...
func (_m *MockDocker) ImageBuild(ctx context.Context, _a1 io.Reader, options types.ImageBuildOptions) (types.ImageBuildResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) ImageCreate(ctx context.Context, parentReference string, options types.ImageCreateOptions) (io.ReadCloser, error) {
...
func (_m *MockDocker) ImageHistory(ctx context.Context, _a1 string) ([]image.HistoryResponseItem, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *MockDocker) ImageImport(ctx context.Context, source types.ImageImportSource, ref string, options types.ImageImportOptions) (io.ReadCloser, error) {
...
func (_m *MockDocker) ImageInspectWithRaw(ctx context.Context, _a1 string) (types.ImageInspect, []byte, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *MockDocker) ImageList(ctx context.Context, options types.ImageListOptions) ([]types.ImageSummary, error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) ImageLoad(ctx context.Context, input io.Reader, quiet bool) (types.ImageLoadResponse, error) {
...
func (_m *MockDocker) ImagePull(ctx context.Context, ref string, options types.ImagePullOptions) (io.ReadCloser, error) {
...
func (_m *MockDocker) ImagePush(ctx context.Context, ref string, options types.ImagePushOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, ref, options)
...
func (_m *MockDocker) ImageRemove(ctx context.Context, _a1 string, options types.ImageRemoveOptions) ([]types.ImageDeleteResponseItem, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) ImageSave(ctx context.Context, images []string) (io.ReadCloser, error) {
...
func (_m *MockDocker) ImageSearch(ctx context.Context, term string, options types.ImageSearchOptions) ([]registry.SearchResult, error) {
...
func (_m *MockDocker) ImageTag(ctx context.Context, _a1 string, ref string) error {
...
func (_m *MockDocker) ImagesPrune(ctx context.Context, pruneFilter filters.Args) (types.ImagesPruneReport, error) {
...
func (_m *MockDocker) Info(ctx context.Context) (types.Info, error) {
	ret := _m.Called(ctx)
...
func (_m *MockDocker) NegotiateAPIVersion(ctx context.Context) {
	_m.Called(ctx)
}

// NegotiateAPIVersionPing provides a mock function with given fields: _a0
func (_m *MockDocker) NegotiateAPIVersionPing(_a0 types.Ping) {
	_m.Called(_a0)
}

// NetworkConnect provides a mock function with given fields: ctx, _a1, _a2, config
func (_m *MockDocker) NetworkConnect(ctx context.Context, _a1 string, _a2 string, config *network.EndpointSettings) error {
...
func (_m *MockDocker) NetworkCreate(ctx context.Context, name string, options types.NetworkCreate) (types.NetworkCreateResponse, error) {
...
func (_m *MockDocker) NetworkDisconnect(ctx context.Context, _a1 string, _a2 string, force bool) error {
...
func (_m *MockDocker) NetworkInspect(ctx context.Context, _a1 string, options types.NetworkInspectOptions) (types.NetworkResource, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) NetworkInspectWithRaw(ctx context.Context, _a1 string, options types.NetworkInspectOptions) (types.NetworkResource, []byte, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *MockDocker) NetworkList(ctx context.Context, options types.NetworkListOptions) ([]types.NetworkResource, error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) NetworkRemove(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *MockDocker) NetworksPrune(ctx context.Context, pruneFilter filters.Args) (types.NetworksPruneReport, error) {
	ret := _m.Called(ctx, pruneFilter)
...
func (_m *MockDocker) NodeInspectWithRaw(ctx context.Context, nodeID string) (swarm.Node, []byte, error) {
...
func (_m *MockDocker) NodeList(ctx context.Context, options types.NodeListOptions) ([]swarm.Node, error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) NodeRemove(ctx context.Context, nodeID string, options types.NodeRemoveOptions) error {
...
func (_m *MockDocker) NodeUpdate(ctx context.Context, nodeID string, version swarm.Version, node swarm.NodeSpec) error {
...
func (_m *MockDocker) Ping(ctx context.Context) (types.Ping, error) {
	ret := _m.Called(ctx)
...
func (_m *MockDocker) PluginCreate(ctx context.Context, createContext io.Reader, options types.PluginCreateOptions) error {
...
func (_m *MockDocker) PluginDisable(ctx context.Context, name string, options types.PluginDisableOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *MockDocker) PluginEnable(ctx context.Context, name string, options types.PluginEnableOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *MockDocker) PluginInspectWithRaw(ctx context.Context, name string) (*types.Plugin, []byte, error) {
	ret := _m.Called(ctx, name)
...
func (_m *MockDocker) PluginInstall(ctx context.Context, name string, options types.PluginInstallOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, name, options)
...
func (_m *MockDocker) PluginList(ctx context.Context, filter filters.Args) (types.PluginsListResponse, error) {
...
func (_m *MockDocker) PluginPush(ctx context.Context, name string, registryAuth string) (io.ReadCloser, error) {
...
func (_m *MockDocker) PluginRemove(ctx context.Context, name string, options types.PluginRemoveOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *MockDocker) PluginSet(ctx context.Context, name string, args []string) error {
...
func (_m *MockDocker) PluginUpgrade(ctx context.Context, name string, options types.PluginInstallOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, name, options)
...
func (_m *MockDocker) RegistryLogin(ctx context.Context, auth types.AuthConfig) (registry.AuthenticateOKBody, error) {
...
func (_m *MockDocker) SecretCreate(ctx context.Context, secret swarm.SecretSpec) (types.SecretCreateResponse, error) {
...
func (_m *MockDocker) SecretInspectWithRaw(ctx context.Context, name string) (swarm.Secret, []byte, error) {
	ret := _m.Called(ctx, name)
...
func (_m *MockDocker) SecretList(ctx context.Context, options types.SecretListOptions) ([]swarm.Secret, error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) SecretRemove(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *MockDocker) SecretUpdate(ctx context.Context, id string, version swarm.Version, secret swarm.SecretSpec) error {
...
func (_m *MockDocker) ServerVersion(ctx context.Context) (types.Version, error) {
	ret := _m.Called(ctx)
...
func (_m *MockDocker) ServiceCreate(ctx context.Context, service swarm.ServiceSpec, options types.ServiceCreateOptions) (types.ServiceCreateResponse, error) {
...
func (_m *MockDocker) ServiceInspectWithRaw(ctx context.Context, serviceID string, options types.ServiceInspectOptions) (swarm.Service, []byte, error) {
...
func (_m *MockDocker) ServiceList(ctx context.Context, options types.ServiceListOptions) ([]swarm.Service, error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) ServiceLogs(ctx context.Context, serviceID string, options types.ContainerLogsOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, serviceID, options)
...
func (_m *MockDocker) ServiceRemove(ctx context.Context, serviceID string) error {
...
func (_m *MockDocker) ServiceUpdate(ctx context.Context, serviceID string, version swarm.Version, service swarm.ServiceSpec, options types.ServiceUpdateOptions) (types.ServiceUpdateResponse, error) {
...
func (_m *MockDocker) SwarmGetUnlockKey(ctx context.Context) (types.SwarmUnlockKeyResponse, error) {
	ret := _m.Called(ctx)
...
func (_m *MockDocker) SwarmInit(ctx context.Context, req swarm.InitRequest) (string, error) {
...
func (_m *MockDocker) SwarmInspect(ctx context.Context) (swarm.Swarm, error) {
	ret := _m.Called(ctx)
...
func (_m *MockDocker) SwarmJoin(ctx context.Context, req swarm.JoinRequest) error {
	ret := _m.Called(ctx, req)
...
func (_m *MockDocker) SwarmLeave(ctx context.Context, force bool) error {
...
func (_m *MockDocker) SwarmUnlock(ctx context.Context, req swarm.UnlockRequest) error {
	ret := _m.Called(ctx, req)
...
func (_m *MockDocker) SwarmUpdate(ctx context.Context, version swarm.Version, _a2 swarm.Spec, flags swarm.UpdateFlags) error {
...
func (_m *MockDocker) TaskInspectWithRaw(ctx context.Context, taskID string) (swarm.Task, []byte, error) {
...
func (_m *MockDocker) TaskList(ctx context.Context, options types.TaskListOptions) ([]swarm.Task, error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) TaskLogs(ctx context.Context, taskID string, options types.ContainerLogsOptions) (io.ReadCloser, error) {
...
func (_m *MockDocker) VolumeCreate(ctx context.Context, options volume.VolumeCreateBody) (types.Volume, error) {
	ret := _m.Called(ctx, options)
...
func (_m *MockDocker) VolumeInspect(ctx context.Context, volumeID string) (types.Volume, error) {
...
func (_m *MockDocker) VolumeInspectWithRaw(ctx context.Context, volumeID string) (types.Volume, []byte, error) {
	ret := _m.Called(ctx, volumeID)
...
func (_m *MockDocker) VolumeList(ctx context.Context, filter filters.Args) (volume.VolumeListOKBody, error) {
	ret := _m.Called(ctx, filter)
...
func (_m *MockDocker) VolumeRemove(ctx context.Context, volumeID string, force bool) error {
...
func (_m *MockDocker) VolumesPrune(ctx context.Context, pruneFilter filters.Args) (types.VolumesPruneReport, error) {
	ret := _m.Called(ctx, pruneFilter)
