...
const (
	...
	Process_Node_Filter_Condition_PREDICATE_UNSPECIFIED Process_Node_Filter_Condition_Predicate = 0
	// Equal
	Process_Node_Filter_Condition_PREDICATE_EQ Process_Node_Filter_Condition_Predicate = 1
)
...
type Process_Node_Result struct {
	...
	InstanceHash github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,2,opt,name=instance_hash,json=instanceHash,proto3,customtype=github.com/mesg-foundation/engine/hash.Hash" json:"instance_hash" hash:"name:2" validate:"required"`
	// Key of the task that triggers the process.
	TaskKey              string   `protobuf:"bytes,3,opt,name=task_key,json=taskKey,proto3" json:"task_key,omitempty" hash:"name:3" validate:"printascii,required"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Process_Node_Event struct {
	...
	EventKey             string   `protobuf:"bytes,3,opt,name=event_key,json=eventKey,proto3" json:"event_key,omitempty" hash:"name:3" validate:"printascii,required"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Process_Node_Map_Output_Reference struct {
	...
	NodeKey string `protobuf:"bytes,1,opt,name=node_key,json=nodeKey,proto3" json:"node_key,omitempty" hash:"name:1" validate:"required"`
...
type Process_Node_Filter_Condition struct {
	...
	Predicate Process_Node_Filter_Condition_Predicate `protobuf:"varint,2,opt,name=predicate,proto3,enum=mesg.types.v1.Process_Node_Filter_Condition_Predicate" json:"predicate,omitempty" hash:"name:2" validate:"required"`
	// Value of the filter.
...
func init() {
	proto.RegisterEnum("mesg.types.v1.Process_Node_Filter_Condition_Predicate", Process_Node_Filter_Condition_Predicate_name, Process_Node_Filter_Condition_Predicate_value)
	proto.RegisterType((*Process)(nil), "mesg.types.v1.Process")
	proto.RegisterType((*Process_Node)(nil), "mesg.types.v1.Process.Node")
	proto.RegisterType((*Process_Node_Result)(nil), "mesg.types.v1.Process.Node.Result")
	proto.RegisterType((*Process_Node_Event)(nil), "mesg.types.v1.Process.Node.Event")
	proto.RegisterType((*Process_Node_Task)(nil), "mesg.types.v1.Process.Node.Task")
	proto.RegisterType((*Process_Node_Map)(nil), "mesg.types.v1.Process.Node.Map")
	proto.RegisterType((*Process_Node_Map_Output)(nil), "mesg.types.v1.Process.Node.Map.Output")
	proto.RegisterType((*Process_Node_Map_Output_Reference)(nil), "mesg.types.v1.Process.Node.Map.Output.Reference")
	proto.RegisterType((*Process_Node_Filter)(nil), "mesg.types.v1.Process.Node.Filter")
	proto.RegisterType((*Process_Node_Filter_Condition)(nil), "mesg.types.v1.Process.Node.Filter.Condition")
	proto.RegisterType((*Process_Edge)(nil), "mesg.types.v1.Process.Edge")
}
...
var fileDescriptor_54c4d0e8c0aaf5c3 = []byte{
	...
	,
}
