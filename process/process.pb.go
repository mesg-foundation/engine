...
type Process_Node_Map_Output struct {
	...
	//	*Process_Node_Map_Output_Constant_
...
type Process_Node_Map_Output_Null_ struct {
	Null Process_Node_Map_Output_Null `protobuf:"varint,1,opt,name=null,proto3,enum=mesg.types.Process_Node_Map_Output_Null,oneof" json:"null,omitempty" hash:"name:1" validate:"required_without=Ref Constant List Map"`
}
type Process_Node_Map_Output_Ref struct {
	Ref *Process_Node_Map_Output_Reference `protobuf:"bytes,2,opt,name=ref,proto3,oneof" json:"ref,omitempty" hash:"name:2" validate:"required_without=Null Constant List Map"`
}
type Process_Node_Map_Output_Constant_ struct {
	Constant *Process_Node_Map_Output_Constant `protobuf:"bytes,3,opt,name=constant,proto3,oneof" json:"constant,omitempty" hash:"name:3" validate:"required_without=Null Ref List Map"`
}
type Process_Node_Map_Output_List_ struct {
	List *Process_Node_Map_Output_List `protobuf:"bytes,4,opt,name=list,proto3,oneof" json:"list,omitempty" hash:"name:4" validate:"required_without=Null Ref Constant Map"`
}
type Process_Node_Map_Output_Map_ struct {
	Map *Process_Node_Map_Output_Map `protobuf:"bytes,5,opt,name=map,proto3,oneof" json:"map,omitempty" hash:"name:5" validate:"required_without=Null Ref Constant List"`
}
...
func (*Process_Node_Map_Output_Constant_) isProcess_Node_Map_Output_Value() {}
...
func (m *Process_Node_Map_Output) GetConstant() *Process_Node_Map_Output_Constant {
	if x, ok := m.GetValue().(*Process_Node_Map_Output_Constant_); ok {
		return x.Constant
	}
	return nil
}
...
func (*Process_Node_Map_Output) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Process_Node_Map_Output_Constant_)(nil),
...
type Process_Node_Map_Output_Constant struct {
	StringConst          string   `protobuf:"bytes,1,opt,name=string_const,json=stringConst,proto3" json:"string_const,omitempty" hash:"name:1"`
	DoubleConst          float64  `protobuf:"fixed64,2,opt,name=double_const,json=doubleConst,proto3" json:"double_const,omitempty" hash:"name:2"`
	BoolConst            bool     `protobuf:"varint,3,opt,name=bool_const,json=boolConst,proto3" json:"bool_const,omitempty" hash:"name:3"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *Process_Node_Map_Output_Constant) Reset()         { *m = Process_Node_Map_Output_Constant{} }
func (m *Process_Node_Map_Output_Constant) String() string { return proto.CompactTextString(m) }
func (*Process_Node_Map_Output_Constant) ProtoMessage()    {}
func (*Process_Node_Map_Output_Constant) Descriptor() ([]byte, []int) {
	return fileDescriptor_54c4d0e8c0aaf5c3, []int{0, 0, 3, 0, 0}
}
func (m *Process_Node_Map_Output_Constant) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Process_Node_Map_Output_Constant.Unmarshal(m, b)
}
func (m *Process_Node_Map_Output_Constant) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Process_Node_Map_Output_Constant.Marshal(b, m, deterministic)
}
func (m *Process_Node_Map_Output_Constant) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Process_Node_Map_Output_Constant.Merge(m, src)
}
func (m *Process_Node_Map_Output_Constant) XXX_Size() int {
	return xxx_messageInfo_Process_Node_Map_Output_Constant.Size(m)
}
func (m *Process_Node_Map_Output_Constant) XXX_DiscardUnknown() {
	xxx_messageInfo_Process_Node_Map_Output_Constant.DiscardUnknown(m)
}

var xxx_messageInfo_Process_Node_Map_Output_Constant proto.InternalMessageInfo
...
func (*Process_Node_Map_Output_Reference) Descriptor() ([]byte, []int) {
	return fileDescriptor_54c4d0e8c0aaf5c3, []int{0, 0, 3, 0, 3}
}
...
func init() {
	...
	proto.RegisterType((*Process_Node_Map_Output_Constant)(nil), "mesg.types.Process.Node.Map.Output.Constant")
...
var fileDescriptor_54c4d0e8c0aaf5c3 = []byte{
	...
	,
}
...
func (this *Process_Node_Map_Output_Constant_) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Process_Node_Map_Output_Constant_)
	if !ok {
		that2, ok := that.(Process_Node_Map_Output_Constant_)
		if ok {
			that1 = &that2
		} else {
			return false
