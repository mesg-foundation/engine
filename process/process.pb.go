...
type Process struct {
	// Process's hash
	Hash github_com_mesg_foundation_engine_cosmos_address.ProcAddress `protobuf:"bytes,1,opt,name=hash,proto3,casttype=github.com/mesg-foundation/engine/cosmos/address.ProcAddress" json:"hash,omitempty" hash:"-" validate:"required"`
	// Process's name
...
type Process_Node_Result struct {
	...
	InstanceHash github_com_mesg_foundation_engine_cosmos_address.InstAddress `protobuf:"bytes,2,opt,name=instanceHash,proto3,casttype=github.com/mesg-foundation/engine/cosmos/address.InstAddress" json:"instanceHash,omitempty" hash:"name:2" validate:"required"`
...
var fileDescriptor_54c4d0e8c0aaf5c3 = []byte{
	...
	,
}
