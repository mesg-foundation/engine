...
type Process_Node_Map_Output_Reference struct {
	...
	// Index of a specific parameter of the referenced node's output data.
	OutputIndex          uint32   `protobuf:"varint,2,opt,name=outputIndex,proto3" json:"outputIndex,omitempty" hash:"name:2"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Process_Node_Filter_Condition struct {
	// Index of a specific parameter of the previous node's output data.
	Index uint32 `protobuf:"varint,1,opt,name=index,proto3" json:"index,omitempty" hash:"name:1"`
...
var fileDescriptor_54c4d0e8c0aaf5c3 = []byte{
	...
	,
}
