...
type Process_Node_Map_Output_DoubleConst struct {
	DoubleConst float64 `protobuf:"fixed64,3,opt,name=double_const,json=doubleConst,proto3,oneof" json:"double_const,omitempty" hash:"name:3"`
}
...
type Process_Node_Map_Output_Ref struct {
	Ref *Process_Node_Map_Output_Reference `protobuf:"bytes,5,opt,name=ref,proto3,oneof" json:"ref,omitempty" hash:"name:5" validate:"required_without=Null Constant List Map"`
}
type Process_Node_Map_Output_List_ struct {
	List *Process_Node_Map_Output_List `protobuf:"bytes,6,opt,name=list,proto3,oneof" json:"list,omitempty" hash:"name:6" validate:"required_without=Null Ref Constant Map"`
}
type Process_Node_Map_Output_Map_ struct {
	Map *Process_Node_Map_Output_Map `protobuf:"bytes,7,opt,name=map,proto3,oneof" json:"map,omitempty" hash:"name:6" validate:"required_without=Null Ref Constant List"`
}
...
type Process_Node_Map_Output_Reference struct {
	...
	Path                 *Process_Node_Map_Output_Reference_Path `protobuf:"bytes,2,opt,name=path,proto3" json:"path,omitempty" hash:"name:2" validate:"required"`
	XXX_NoUnkeyedLiteral struct{}                                `json:"-"`
	XXX_unrecognized     []byte                                  `json:"-"`
	XXX_sizecache        int32                                   `json:"-"`
}
...
var fileDescriptor_54c4d0e8c0aaf5c3 = []byte{
	...
	,
}
