...
type Process_Node_Result_ struct {
	Result *Process_Node_Result `protobuf:"bytes,2,opt,name=result,proto3,oneof" json:"result,omitempty" hash:"name:1"`
}
type Process_Node_Event_ struct {
	Event *Process_Node_Event `protobuf:"bytes,3,opt,name=event,proto3,oneof" json:"event,omitempty" hash:"name:2"`
}
type Process_Node_Task_ struct {
	Task *Process_Node_Task `protobuf:"bytes,4,opt,name=task,proto3,oneof" json:"task,omitempty" hash:"name:3"`
}
type Process_Node_Map_ struct {
	Map *Process_Node_Map `protobuf:"bytes,5,opt,name=map,proto3,oneof" json:"map,omitempty" hash:"name:4"`
}
type Process_Node_Filter_ struct {
	Filter *Process_Node_Filter `protobuf:"bytes,6,opt,name=filter,proto3,oneof" json:"filter,omitempty" hash:"name:5"`
}
...
var fileDescriptor_54c4d0e8c0aaf5c3 = []byte{
	...
	,
}
