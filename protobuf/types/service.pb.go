...
type Service_Workflow_Trigger_TriggerType int32

const (
	Service_Workflow_Trigger_Event  Service_Workflow_Trigger_TriggerType = 0
	Service_Workflow_Trigger_Result Service_Workflow_Trigger_TriggerType = 1
)

var Service_Workflow_Trigger_TriggerType_name = map[int32]string{
	0: "Event",
	1: "Result",
}

var Service_Workflow_Trigger_TriggerType_value = map[string]int32{
	"Event":  0,
	"Result": 1,
}

func (x Service_Workflow_Trigger_TriggerType) String() string {
	return proto.EnumName(Service_Workflow_Trigger_TriggerType_name, int32(x))
}

func (Service_Workflow_Trigger_TriggerType) EnumDescriptor() ([]byte, []int) {
...
type Service_Workflow_Trigger struct {
	Type                 Service_Workflow_Trigger_TriggerType `protobuf:"varint,1,opt,name=type,proto3,enum=types.Service_Workflow_Trigger_TriggerType" json:"type,omitempty"`
...
func (m *Service_Workflow_Trigger) GetType() Service_Workflow_Trigger_TriggerType {
	if m != nil {
		return m.Type
	}
...
func init() {
	proto.RegisterEnum("types.Service_Workflow_Trigger_TriggerType", Service_Workflow_Trigger_TriggerType_name, Service_Workflow_Trigger_TriggerType_value)
...
var fileDescriptor_578ec16019661f8f = []byte{
	...
	,
}
