...
type CreateExecutionRequest struct {
	...
	ParentHash   github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,5,opt,name=parentHash,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"parentHash" validate:"omitempty,hash"`
	EventHash    github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,6,opt,name=eventHash,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"eventHash" validate:"omitempty,hash"`
	ProcessHash  github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,7,opt,name=processHash,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"processHash" validate:"omitempty,hash"`
	NodeKey      string                                        `protobuf:"bytes,8,opt,name=nodeKey,proto3" json:"nodeKey,omitempty"`
	ExecutorHash github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,9,opt,name=executorHash,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"executorHash" validate:"omitempty,hash"`
...
type StreamExecutionRequest_Filter struct {
	...
	ExecutorHash         github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,5,opt,name=executorHash,proto3,customtype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"executorHash" validate:"omitempty,hash"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}
...
var fileDescriptor_96e2c86581f82f05 = []byte{
	...
	,
}
