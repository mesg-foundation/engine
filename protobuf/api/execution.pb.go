...
type CreateExecutionRequest struct {
	...
	ParentHash           github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,5,opt,name=parentHash,proto3,customtype=github.com/mesg-foundation/engine/hash.Hash" json:"parentHash" validate:"hash"`
	EventHash            github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,6,opt,name=eventHash,proto3,customtype=github.com/mesg-foundation/engine/hash.Hash" json:"eventHash" validate:"hash"`
	ProcessHash          github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,7,opt,name=processHash,proto3,customtype=github.com/mesg-foundation/engine/hash.Hash" json:"processHash" validate:"hash"`
	StepID               string                                      `protobuf:"bytes,8,opt,name=stepID,proto3" json:"stepID,omitempty"`
	ExecutorHash         github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,9,opt,name=executorHash,proto3,customtype=github.com/mesg-foundation/engine/hash.Hash" json:"executorHash" validate:"hash"`
...
var fileDescriptor_96e2c86581f82f05 = []byte{
	...
	,
}
