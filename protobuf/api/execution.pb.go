...
type CreateExecutionRequest struct {
	...
	// confs is the number of conrimations the exeuction needs to have before changeing status to passed
	Confs int64 `protobuf:"varint,11,opt,name=confs,proto3" json:"confs,omitempty"`
	// confs is the number of conrimations the exeuction needs to have before results could be accepted
	UpdateConfs          int64    `protobuf:"varint,12,opt,name=updateConfs,proto3" json:"updateConfs,omitempty"`
...
func (m *CreateExecutionRequest) GetConfs() int64 {
	if m != nil {
		return m.Confs
	}
	return 0
...
func (m *CreateExecutionRequest) GetUpdateConfs() int64 {
	if m != nil {
		return m.UpdateConfs
	}
	return 0
}
...
var fileDescriptor_96e2c86581f82f05 = []byte{
	...
	,
}
