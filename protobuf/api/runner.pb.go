...
type GetRunnerRequest struct {
	Hash                 github_com_mesg_foundation_engine_cosmos_address.RunAddress `protobuf:"bytes,1,opt,name=hash,proto3,casttype=github.com/mesg-foundation/engine/cosmos/address.RunAddress" json:"hash,omitempty" validate:"required,runaddress"`
...
func (m *GetRunnerRequest) GetHash() github_com_mesg_foundation_engine_cosmos_address.RunAddress {
	if m != nil {
		return m.Hash
	}
	return nil
...
type ListRunnerRequest_Filter struct {
	...
	InstanceHash github_com_mesg_foundation_engine_cosmos_address.InstAddress `protobuf:"bytes,1,opt,name=instanceHash,proto3,casttype=github.com/mesg-foundation/engine/cosmos/address.InstAddress" json:"instanceHash,omitempty" validate:"instaddress"`
	// Filter by address
	// TODO: to cast to accAddress type and change type to bytes
...
func (m *ListRunnerRequest_Filter) GetInstanceHash() github_com_mesg_foundation_engine_cosmos_address.InstAddress {
	if m != nil {
...
type CreateRunnerRequest struct {
	...
	ServiceHash github_com_mesg_foundation_engine_cosmos_address.ServAddress `protobuf:"bytes,1,opt,name=serviceHash,proto3,casttype=github.com/mesg-foundation/engine/cosmos/address.ServAddress" json:"serviceHash,omitempty" validate:"servaddress"`
...
func (m *CreateRunnerRequest) GetServiceHash() github_com_mesg_foundation_engine_cosmos_address.ServAddress {
	if m != nil {
...
type CreateRunnerResponse struct {
	...
	Hash                 github_com_mesg_foundation_engine_cosmos_address.RunAddress `protobuf:"bytes,1,opt,name=hash,proto3,casttype=github.com/mesg-foundation/engine/cosmos/address.RunAddress" json:"hash,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                    `json:"-"`
	XXX_unrecognized     []byte                                                      `json:"-"`
	XXX_sizecache        int32                                                       `json:"-"`
}
...
func (m *CreateRunnerResponse) GetHash() github_com_mesg_foundation_engine_cosmos_address.RunAddress {
	if m != nil {
		return m.Hash
	}
	return nil
...
func (m *DeleteRunnerRequest) GetHash() github_com_mesg_foundation_engine_cosmos_address.RunAddress {
	if m != nil {
		return m.Hash
	}
	return nil
...
var fileDescriptor_66b76d1ada2874b2 = []byte{
	...
	,
}
