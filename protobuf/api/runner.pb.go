...
func (m *GetRunnerRequest) GetHash() github_com_mesg_foundation_engine_hash.Hash {
	if m != nil {
		return m.Hash
	}
	return nil
...
type ListRunnerRequest_Filter struct {
	...
	InstanceHash github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,1,opt,name=instanceHash,proto3,casttype=github.com/mesg-foundation/engine/hash.Hash" json:"instanceHash,omitempty" validate:"hash"`
	// Filter by owner
...
func (m *ListRunnerRequest_Filter) GetInstanceHash() github_com_mesg_foundation_engine_hash.Hash {
	if m != nil {
...
type ListRunnerResponse struct {
	...
	Runners              []*runner.Runner `protobuf:"bytes,1,rep,name=runners,proto3" json:"runners,omitempty" validate:"dive"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
type CreateRunnerRequest struct {
	...
	ServiceHash github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,1,opt,name=serviceHash,proto3,casttype=github.com/mesg-foundation/engine/hash.Hash" json:"serviceHash,omitempty" validate:"hash"`
...
func (m *CreateRunnerRequest) GetServiceHash() github_com_mesg_foundation_engine_hash.Hash {
	if m != nil {
...
func (m *CreateRunnerResponse) GetHash() github_com_mesg_foundation_engine_hash.Hash {
	if m != nil {
		return m.Hash
	}
	return nil
...
func (m *DeleteRunnerRequest) GetHash() github_com_mesg_foundation_engine_hash.Hash {
	if m != nil {
		return m.Hash
	}
	return nil
...
var fileDescriptor_66b76d1ada2874b2 = []byte{
	...
	,
}
