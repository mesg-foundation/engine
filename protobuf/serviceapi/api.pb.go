...
func (*EmitEventRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6379535945cfa59c, []int{0}
}
...
func (*EmitEventReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_6379535945cfa59c, []int{1}
}
...
func (*ListenTaskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6379535945cfa59c, []int{2}
}
...
func (*TaskData) Descriptor() ([]byte, []int) {
	return fileDescriptor_6379535945cfa59c, []int{3}
}
...
func (*SubmitResultRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6379535945cfa59c, []int{4}
}
...
func (*SubmitResultRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func (*SubmitResultReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_6379535945cfa59c, []int{5}
}
...
func init() { proto.RegisterFile("protobuf/serviceapi/api.proto", fileDescriptor_6379535945cfa59c) }

var fileDescriptor_6379535945cfa59c = []byte{
