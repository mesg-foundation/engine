...
func (*Service) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_88ddda8ce50fbb96, []int{0}
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_88ddda8ce50fbb96, []int{1}
}
...
func (*Task) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_88ddda8ce50fbb96, []int{2}
}
...
func (*Parameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_88ddda8ce50fbb96, []int{3}
}
...
func (*Configuration) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_88ddda8ce50fbb96, []int{4}
}
...
func (*Dependency) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_88ddda8ce50fbb96, []int{5}
}
...
func init() {
	proto.RegisterFile("protobuf/definition/service.proto", fileDescriptor_service_88ddda8ce50fbb96)
}

var fileDescriptor_service_88ddda8ce50fbb96 = []byte{
	// 535 bytes of a gzipped FileDescriptorProto
	,
}
