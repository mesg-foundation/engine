...
type Result struct {
	...
	ExecutionHash github_com_mesg_foundation_engine_hash.Hash `protobuf:"bytes,2,opt,name=executionHash,proto3,customtype=github.com/mesg-foundation/engine/hash.Hash" json:"executionHash" hash:"name:2"`
...
var fileDescriptor_4feee897733d2100 = []byte{
	...
	0x2e, 0x29, 0x2a, 0x4d, 0x86, 0x1a, 0xa6, 0x74, 0x84, 0x89, 0x8b, 0x2d, 0x08, 0x6c, 0xba, 0x50,
	...
	0x4f, 0x9e, 0x03, 0xc4, 0xb1, 0x52, 0xd2, 0x55, 0x0a, 0x02, 0x1b, 0x26, 0x94, 0xc5, 0xc5, 0x9b,
	0x5a, 0x91, 0x9a, 0x5c, 0x0a, 0x52, 0x0f, 0x52, 0x22, 0xc1, 0x04, 0x36, 0xdd, 0x85, 0x3c, 0xd3,
	0x79, 0x21, 0xa6, 0xe7, 0x25, 0xe6, 0xa6, 0x5a, 0x19, 0x29, 0x05, 0xa1, 0x1a, 0x2d, 0xe4, 0xc2,
	0xc5, 0x9e, 0x5f, 0x5a, 0x52, 0x50, 0x5a, 0x52, 0x2c, 0xc1, 0xac, 0xc0, 0xa8, 0xc1, 0x6d, 0x24,
	0xaa, 0x07, 0x0e, 0x2a, 0x98, 0xff, 0xf5, 0x82, 0xc1, 0x3e, 0x77, 0x12, 0x44, 0x33, 0xc9, 0x58,
	...
	0x24, 0x66, 0x9c, 0x8c, 0x4e, 0x3c, 0x94, 0x63, 0x58, 0xf1, 0x48, 0x8e, 0x31, 0x4a, 0x83, 0xb0,
	0x8f, 0x20, 0x7a, 0x92, 0xd8, 0xc0, 0xee, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x1a, 0x28,
	0xb8, 0xe7, 0xde, 0x01, 0x00, 0x00,
}
...
func (this *Result) Equal(that interface{}) bool {
	...
	if !this.ExecutionHash.Equal(that1.ExecutionHash) {
		return false
	}
	if that1.Result == nil {
		if this.Result != nil {
