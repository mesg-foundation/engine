...
func queryGetHandlerFn(cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		route := fmt.Sprintf("custom/%s/%s/%s", types.QuerierRoute, types.QueryGetRunner, vars["hash"])
...
func queryListHandlerFn(cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		route := fmt.Sprintf("custom/%s/%s", types.QuerierRoute, types.QueryListRunners)
