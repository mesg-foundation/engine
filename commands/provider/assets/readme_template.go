...
func commandsProviderAssetsReadme_templateMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "commands/provider/assets/readme_template.md", size: 1140, mode: os.FileMode(420), modTime: time.Unix(1537169867, 0)}
