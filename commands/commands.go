...
type ServiceExecutor interface {
	...
	ServiceDeploy(path string, statuses chan provider.DeployStatus, confirmationFunc func(alias string) (deletion bool, err error)) (id string, validationError, err error)
