...
func (*EmitEventRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_0eec7e0a2506b946, []int{0}
}
...
func (*EmitEventReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_0eec7e0a2506b946, []int{1}
}
...
func (*ListenTaskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_0eec7e0a2506b946, []int{2}
}
...
func (*TaskData) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_0eec7e0a2506b946, []int{3}
}
...
func (*SubmitResultRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_0eec7e0a2506b946, []int{4}
}
...
func (*SubmitResultReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_0eec7e0a2506b946, []int{5}
}
...
func init() {
	proto.RegisterFile("github.com/mesg-foundation/core/interface/grpc/service/api.proto", fileDescriptor_api_0eec7e0a2506b946)
}

var fileDescriptor_api_0eec7e0a2506b946 = []byte{
