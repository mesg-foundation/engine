...
func (*EmitEventRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_3166efe0649da3a1, []int{0}
}
...
func (*EmitEventReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_3166efe0649da3a1, []int{1}
}
...
func (*ListenTaskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_3166efe0649da3a1, []int{2}
}
...
func (*TaskData) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_3166efe0649da3a1, []int{3}
}
...
func (*SubmitResultRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_3166efe0649da3a1, []int{4}
}
...
func (*SubmitResultReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_3166efe0649da3a1, []int{5}
}
...
func init() {
	proto.RegisterFile("github.com/mesg-foundation/core/api/service/api.proto", fileDescriptor_api_3166efe0649da3a1)
}

var fileDescriptor_api_3166efe0649da3a1 = []byte{
