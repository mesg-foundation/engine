...
var Import = &cobra.Command{
	...
	Long:  `This method imports a previously exported backup file of your account created with the [export method](mesg-core_account_export.md).`,
	Example: `mesg-core account import ./PATH_TO_BACKUP_FILE
mesg-core account import ./PATH_TO_BACKUP_FILE --password PASSWORD --new-password PASSWORD`,
