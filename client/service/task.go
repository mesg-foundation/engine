...
type Taskable interface {
	...
	// returned by Name().
	Execute(execution *Execution) (result interface{}, err error)
}

// defaultTask implements Task.
type defaultTask struct {
	name    string
	handler func(execution *Execution) (result interface{}, err error)
}
...
func (t *defaultTask) Execute(execution *Execution) (result interface{}, err error) {
...
func Task(key string, handler func(*Execution) (result interface{}, err error)) Taskable {
